import profilePic from "../assets/vashu.png"
      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate = "visible"
              className="pb-16 text-6xl inter-thin tracking-tight lg:mt-16 lg:text-8xl "
              style={{ fontWeight: 50 }}
            >
              Amritanshu Chauhan
            </motion.h1>
            ...
            className="my-2 max-w-xl py-6 font-light tracking-tighter">
              ...
              robust and scalable web application. I have honed my skills in
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            src={profilePic} alt="Amrit" height={500}/>
          </div>
        </div>
      </div>
    </div>
